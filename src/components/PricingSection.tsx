...
const plans = [
  ...
  },
  {
    ...
    features: ['All courses at every level', 'Free software & VSTs included', 'Live classes', 'Feedback on your music', 'Academy student support'],
    icon: ZapIcon,
    featured: true,
  },
  {
    ...
    features: ['Everything in Pro', 'Free software & VSTs included', 'Direct mentorship', 'Personal learning roadmap'],
    icon: CrownIcon,
  },
];
