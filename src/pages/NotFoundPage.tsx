...
export function NotFoundPage() {
  return (
    <>
      <DocumentTitle title="Page Not Found" description="This page could not be found. Return to Lukulu Academy." noIndex />
      <section className="not-found signal-section">
        <div className="page-shell">
          ...
          <p>The page may have moved. Return to the main Academy page.</p>
